...
import { PhoneOutgoing, UserRound, Globe, MapPin, ClipboardList, Smartphone, CalendarDays } from "lucide-react";
    ...
    <>
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="sm:max-w-[412px] p-0 gap-0 overflow-hidden border-border shadow-xl rounded-[20px]">
          <DialogTitle className="sr-only">Outgoing Call 2</DialogTitle>
          ...
          <div className="px-6 py-5 bg-card space-y-4">
            ...
            <div className="rounded-xl border border-onyx-300 p-4 space-y-4">
              ...
              <div className="flex items-baseline justify-between gap-4">
                ...
                <span className="text-sm font-semibold text-foreground text-right">Payment Page</span>
              </div>
            </div>
          </div>
