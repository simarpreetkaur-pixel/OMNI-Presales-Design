            ...
            <div className="rounded-xl border border-[#e7e7f0] p-4 space-y-3">
              ...
              <div className="bg-[#f8f7fc] rounded-xl p-3 space-y-3">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm font-small text-[#36354c]">AI Summary:</span>
                </div>
                <div className="space-y-2">
                  <div className="flex gap-2">
                    <div className="w-1.5 h-1.5 rounded-full bg-[#36354c] mt-2 shrink-0"></div>
                    <span className="text-sm text-[#36354c]">Discussed RSA and Zero Dep.</span>
                  </div>
                  <div className="flex gap-2">
                    <div className="w-1.5 h-1.5 rounded-full bg-[#36354c] mt-2 shrink-0"></div>
                    <span className="text-sm text-[#36354c]">Mentioned to discuss with Wife and decide.</span>
                  </div>
                </div>
              </div>
            </div>
