...
interface OutgoingCallModalFifthCallProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
}

const OutgoingCallModalFifthCall = ({ open, onOpenChange }: OutgoingCallModalFifthCallProps) => {
    ...
    <>
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="w-full max-w-md p-0 gap-0 overflow-hidden border-border shadow-xl rounded-[24px] [&>button:last-child]:hidden">
          <DialogTitle className="sr-only">5th call – Sampada Tambolkar</DialogTitle>
            ...
            <div className="rounded-xl border border-[#e7e7f0] p-4 space-y-3">
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="bg-[#f8f7fc] px-2.5 py-1 rounded-md flex items-center gap-1.5">
                  ...
                  <span className="text-xs font-medium text-[#36354c]">App</span>
                </div>
              </div>
              <div className="flex items-center justify-between">
              ...
              <div className="bg-[#f8f7fc] rounded-xl p-3 space-y-3">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm font-small text-[#36354c]">{SAMPADA_FIFTH_LAST_CALL_LABEL}:</span>
                </div>
                <div className="space-y-2">
                  {SAMPADA_FIFTH_LAST_CALL_BULLETS.map((bullet) => (
          ...
          <div className="px-6 pb-4 pt-4 flex items-center gap-3 bg-white">
            ...
            <Button
              ...
              disabled={!isConnected}
              onClick={() => { onOpenChange(false); navigate("/crm2", { state: { customer: "fifth-call" } }); }}>
              Continue
            </Button>
          </div>
        </DialogContent>
...
export default OutgoingCallModalFifthCall;
